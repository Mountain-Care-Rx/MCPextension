    ...
    if (typeof updateClickableDisplayValue === 'function') {
      ...
      if (phoneTextElem) {
        ...
        if (phoneDisplayElem) {
          ...
          const newDisplay = phoneDisplayElem.cloneNode(true);
          phoneDisplayElem.parentNode.replaceChild(newDisplay, phoneDisplayElem);
          // Left click: copy with formatting
          ...
          // Right click: copy with @ and only digits
          newDisplay.addEventListener('contextmenu', (e) => {
            ...
            if (phone) {
              ...
              if (typeof showToast === 'function') {
                showToast('Phone number copied with @!');
              } else {
                alert('Phone number copied with @!');
              }
            }
          });
        }
